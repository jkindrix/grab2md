...
from grab2md.utils.redaction import RedactingFilter
...
DEFAULT_LOG_FILE = os.path.join(DEFAULT_LOG_DIR, "grab2md.log")

LOG_FILE = os.getenv("GRAB2MD_LOG_PATH", DEFAULT_LOG_FILE)
