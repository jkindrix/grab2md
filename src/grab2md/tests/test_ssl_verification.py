...
import grab2md.cookies.http_session as http_session
...
class TestGetSession:
    ...
    def test_verify_ssl_false_warns(self, caplog):
        with caplog.at_level(logging.WARNING, logger="grab2md"):
...
class TestHtmlToMarkdownVerifySsl:
    ...
    def route_mock_session(self, monkeypatch):
        ...
        monkeypatch.setattr("grab2md.markdown.pipeline.guarded_request", request)
    ...
    def test_ssl_error_returns_none(self, caplog):
        ...
        with caplog.at_level(logging.ERROR, logger="grab2md"):
