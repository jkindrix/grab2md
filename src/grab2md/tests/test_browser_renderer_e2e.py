...
from grab2md.network.auth_inputs import load_storage_state
from grab2md.network.browser_renderer import RenderError, render_html
...
def test_static_and_browser_modes_have_deterministic_distinct_output():
    if os.getenv("GRAB2MD_RUN_RENDER_E2E") != "1":
        pytest.skip("set GRAB2MD_RUN_RENDER_E2E=1 with the render extra and Chromium")
