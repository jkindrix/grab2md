...
from grab2md.cli import conversion_service
...
def test_url_conversion_builds_one_session_and_threads_security_options(
    ...
    header_manager = Mock()
    header_manager.get_headers.return_value = {"User-Agent": "grab2md-test"}
    ...
    assert acquire.call_args.kwargs["headers"] == {"User-Agent": "grab2md-test"}
