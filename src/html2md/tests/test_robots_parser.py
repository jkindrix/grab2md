...
class TestRobotsChecker:
    ...
    def test_get_robots_url(self):
        ...
        assert checker._get_robots_url("http://sub.example.com/path/to/page") == "http://sub.example.com/robots.txt"
        assert checker._get_robots_url("https://example.com:8080/") == "https://example.com:8080/robots.txt"
...
"""
        ...
        assert checker2.can_fetch("https://example.com/restricted/page") is True  # Not restricted for GoodBot
