...
class TestHeaderManager:
    ...
    def test_conditional_requests_disabled(self):
        ...
        manager.update_last_modified("https://example.com", "Wed, 15 Nov 2023 12:00:00 GMT")
        headers = manager.get_headers("https://example.com")
    ...
    def test_cache_management(self):
        ...
        manager.update_last_modified("https://example.com", "Wed, 15 Nov 2023 12:00:00 GMT")
        assert manager.get_last_modified("https://example.com") == "Wed, 15 Nov 2023 12:00:00 GMT"
