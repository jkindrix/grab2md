"""Explicit validation and CLI parsing for html2md configuration."""
...
VALUE_TYPES: dict[ConfigPath, tuple[type, ...]] = {
    ...
    ("headers", "user_agent_version"): (str,),
    ("headers", "enable_compression"): (bool,),
    ("headers", "compression_methods"): (str,),
    ("headers", "enable_conditional_requests"): (bool,),
    ("headers", "simulate_browser"): (bool,),
    ("headers", "browser_type"): (str,),
