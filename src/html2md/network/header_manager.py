...
class HeaderManager:
    ...
    def get_headers(self, url: str, last_modified: Optional[str] = None) -> Dict[str, str]:
        """
        ...
        logger.debug(f"Generated headers for {url}: User-Agent={headers.get('User-Agent', 'None')[:50]}...")
        return headers
    ...
    def _build_user_agent(self) -> str:
        ...
        ua_parts = [
            f"{self.config.user_agent_name}/{self.config.user_agent_version}"
        ]
