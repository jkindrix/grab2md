...
On 2026-07-16, Python 3.11.2 measured 4,753 production statements, 1,850 missed, and 61% total coverage. The enforced floor is 59%, which allows rounding and small interpreter-dependent line differences while preventing a material regression. The floor must not be lowered to make a change pass.
...
| `utils/progress_display.py` | 155 | 155 | 0% | H2M-050 |
| `network/concurrent_controller.py` | 226 | 139 | 38% | H2M-047 |
| `network/chatgpt_handler.py` | 221 | 135 | 39% | H2M-036–046 |
| `network/request_queue.py` | 167 | 80 | 52% | H2M-047 |
| `network/concurrent_limiter.py` | 199 | 63 | 68% | H2M-048 |
